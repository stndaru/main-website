    ...
    >
      <div className='relative min-w-full min-h-screen'>
        ...
        <div className='absolute top-0 w-full h-full'>
          <div className='flex flex-col gap-y-8 items-center justify-center content-center self-center p-16 h-full'>
            ...
            <div className='flex flex-col gap-y-8'>
              <h3>In the meantime, you can check my social accounts below</h3>
              <div className='flex flex-col gap-y-8'>
